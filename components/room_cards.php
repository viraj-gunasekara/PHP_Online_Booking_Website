  ...
  <div class="row">
    ...
    <div class="col-lg-4 col-md-6 my-3">
      <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
        ...
        <div class="card-body">
          <h5>Rominrich Luxury Inn</h5>
          <h6 class="mb-2">Rs. 1800 per night</h6>
          <!-- location -->
          <div class="location mb-4">
            <span class="font-monospace">Location: </span>
            <span class="badge rounded-pill bg-light text-dark text-wrap">Lake Gregory, Nuwara Eliya</span>
          </div>
          <!-- features -->
    ...
    <div class="col-lg-12 text-center mt-5">
      <a href="#" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">View More Rooms >>></a>
    </div>
  </div>
</div>
